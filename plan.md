...
- [ ] Set up SQLModel database models (Account, Contact, Relationship, RelationshipLog)
- [ ] Configure SQLite database connection and table creation
- [ ] Create base layout with left sidebar for accounts list
- [ ] Implement searchable accounts list with filter functionality
- [ ] Add main content area that displays when an account is selected
