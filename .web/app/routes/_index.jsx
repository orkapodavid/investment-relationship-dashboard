...
function Button_c11cea80825d65c51dd3722fd916bca2 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
const on_click_928ccc08d030188db40bb6156b3c7ece = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___relationship_state____relationship_state.start_node_creation", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])
  ...
  return (
    jsx("button",{className:"absolute top-4 right-16 z-50 flex items-center px-4 py-2.5 text-sm text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition-colors font-semibold shadow-md hover:shadow-lg whitespace-nowrap",onClick:on_click_928ccc08d030188db40bb6156b3c7ece},jsx(LucidePlus,{className:"w-5 h-5 mr-2"},),"New Entity")
  )
}
...
function Fragment_39c44ea825b65f870d5ac3dee8d5e4e0 () {
  const reflex___state____state__app___states___relationship_state____relationship_state = useContext(StateContexts.reflex___state____state__app___states___relationship_state____relationship_state)
...
function Aside_210b10aae43aeb0ed13d8b4b9a92c68e () {
  const reflex___state____state__app___states___relationship_state____relationship_state = useContext(StateContexts.reflex___state____state__app___states___relationship_state____relationship_state)



  return (
    jsx("aside",{"aria-label":"Side Panel",className:(reflex___state____state__app___states___relationship_state____relationship_state.show_side_panel_rx_state_ ? "fixed top-0 right-0 h-full w-96 bg-white shadow-2xl z-[100] transform transition-transform duration-300 ease-in-out translate-x-0 border-l border-gray-200 flex flex-col" : "fixed top-0 right-0 h-full w-96 bg-white shadow-2xl z-[100] transform transition-transform duration-300 ease-in-out translate-x-full border-l border-gray-200 flex flex-col")},jsx(Fragment_39c44ea825b65f870d5ac3dee8d5e4e0,{},),jsx(Fragment_d860fd4c6d998f8315e22edbbca9338a,{},),jsx(Fragment_0105e875379a4cd15f0bc44235b3bb59,{},),jsx(Fragment_1bf05f1da0744f8bf26f3ce7b88d8004,{},),jsx(Fragment_fae5bd58257b0d36b4df7c913455e174,{},))
  )
}
