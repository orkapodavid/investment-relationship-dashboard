...
function Button_0cc1a76868531864065ea6b7f617f6f7 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
const on_click_928ccc08d030188db40bb6156b3c7ece = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___relationship_state____relationship_state.start_node_creation", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])
  ...
  return (
    jsx("button",{className:"absolute bottom-8 right-8 z-[9999] bg-red-600 text-white font-bold p-6 text-xl border-4 border-black rounded-lg shadow-2xl hover:bg-red-700",css:({ ["position"] : "absolute", ["bottom"] : "50px", ["right"] : "50px", ["zIndex"] : "9999" }),onClick:on_click_928ccc08d030188db40bb6156b3c7ece},"DEBUG: NEW ENTITY")
  )
}
