...
function Button_9e3746d46773e2ee73e1f67cf97df9ee () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
const on_click_928ccc08d030188db40bb6156b3c7ece = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___relationship_state____relationship_state.start_node_creation", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])
  ...
  return (
    jsx("button",{className:"absolute top-6 right-6 z-[9999] w-20 h-20 bg-red-500 hover:bg-red-600 border-4 border-white rounded-full shadow-2xl flex items-center justify-center transition-all duration-200 ease-in-out transform hover:scale-105 active:scale-95 pointer-events-auto cursor-pointer",onClick:on_click_928ccc08d030188db40bb6156b3c7ece,title:"Create New Entity (Debug)"},jsx("span",{className:"font-black text-white mr-1 text-sm"},"NEW"),jsx(LucidePlus,{className:"w-8 h-8 text-white"},))
  )
}
