...
function Button_c66322bcef124b44b47cec1179c93f9f () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
const on_click_928ccc08d030188db40bb6156b3c7ece = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___relationship_state____relationship_state.start_node_creation", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])
  ...
  return (
    jsx("button",{className:"fixed top-0 right-0 z-[9999] bg-red-500 text-white p-4 font-bold border-4 border-black",onClick:on_click_928ccc08d030188db40bb6156b3c7ece},"TEST BUTTON")
  )
}
