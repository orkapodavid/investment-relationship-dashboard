...
function Reactflow_2bde6da0206dc0e24639c039ffbec1d1 () {
...
const on_connect_76b888e930b91c73d3aa07cbd5e4b9da = useCallback(((_ev_0) => (addEvents([(ReflexEvent("reflex___state____state.app___states___relationship_state____relationship_state.on_connect", ({ ["params"] : _ev_0 }), ({  })))], [_ev_0], ({  })))), [addEvents, ReflexEvent])

  return (
    jsx(ReactFlow,{className:"bg-gray-50 w-full h-full",edges:reflex___state____state__app___states___relationship_state____relationship_state.edges_rx_state_,edgesFocusable:true,fitView:true,fitViewOptions:({ ["padding"] : 0.2 }),maxZoom:4.0,minZoom:0.1,nodes:reflex___state____state__app___states___relationship_state____relationship_state.nodes_rx_state_,nodesConnectable:true,nodesDraggable:true,nodesFocusable:true,onConnect:on_connect_76b888e930b91c73d3aa07cbd5e4b9da,onEdgeClick:on_edge_click_e2f95da83301f88b1122896b4b556a07,onEdgesChange:on_edges_change_810a8c315930f759f969bafb17bea711,onNodeClick:on_node_click_aaeec5d9b52d48064d35abcf023ce6ad,onNodesChange:on_nodes_change_261f9ed27d4adef0255f83998c49f8e6,onViewportChange:on_viewport_change_1ecb808a120917d26638f25407698d79,panOnDrag:true,panOnScroll:false,selectNodesOnDrag:false,snapToGrid:false,zoomOnDoubleClick:false,zoomOnScroll:true},jsx(Background,{gap:12,size:1,variant:"dots"},),jsx(Controls,{position:"bottom-right",showFitView:true,showInteractive:true,showZoom:true},),jsx(MiniMap,{nodeColor:"#93c5fd",pannable:true,position:"bottom-left",zoomable:true},))
  )
}
