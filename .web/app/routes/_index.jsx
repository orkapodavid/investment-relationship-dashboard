...
function Button_708b6b7d2a50a6a8ccd2ad026306d1d0 () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
const on_click_928ccc08d030188db40bb6156b3c7ece = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___relationship_state____relationship_state.start_node_creation", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])
  ...
  return (
    jsx("button",{"aria-label":"Create New Entity",className:"p-4 text-white bg-indigo-600 hover:bg-indigo-700 rounded-full shadow-2xl hover:scale-110 active:scale-95 flex items-center justify-center border-4 border-white pointer-events-auto transition-all cursor-pointer",onClick:on_click_928ccc08d030188db40bb6156b3c7ece},jsx(LucidePlus,{className:"w-8 h-8"},))
  )
}
...
function Aside_45ce0ccf422c2286412e54a9476162e2 () {
  const reflex___state____state__app___states___relationship_state____relationship_state = useContext(StateContexts.reflex___state____state__app___states___relationship_state____relationship_state)
