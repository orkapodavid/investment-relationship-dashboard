...
function Button_0ca87e13ba36798bc1da5495e8ebc53d () {
  const [addEvents, connectErrors] = useContext(EventLoopContext);
...
const on_click_928ccc08d030188db40bb6156b3c7ece = useCallback(((_e) => (addEvents([(ReflexEvent("reflex___state____state.app___states___relationship_state____relationship_state.start_node_creation", ({  }), ({  })))], [_e], ({  })))), [addEvents, ReflexEvent])
  ...
  return (
    jsx("button",{className:"fixed top-6 right-6 z-[60] w-14 h-14 bg-indigo-600 hover:bg-indigo-700 border-2 border-white rounded-full shadow-2xl flex items-center justify-center transition-all duration-200 ease-in-out transform hover:scale-105 active:scale-95",onClick:on_click_928ccc08d030188db40bb6156b3c7ece,title:"Create New Entity"},jsx(LucidePlus,{className:"w-8 h-8 text-white"},))
  )
}
